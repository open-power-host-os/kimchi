...
messages = {
    ...
    "KCHVM0054E": _("VM '%(vm)s' cannot have more than %(cpus)s CPUs. Please update the CPU value when the VM is not running."),
    "KCHVM0055E": _("VM '%(vm)s' cannot have less than %(cpus)s CPUs. Please update the CPU value when the VM is not running."),
    ...
    "KCHVM0058E": _("Memory value %(mem)s must be aligned to 256MiB."),
    "KCHVM0059E": _("Topology is set: cores='%(cores)s' and threads='%(threads)s'. New CPU value must be multiple of '%(mult)s' (cores * threads)"),
    ...
    "KCHVMHDEV0007E": _('Hot-(un)plug of device %(name)s is not supported.'),
