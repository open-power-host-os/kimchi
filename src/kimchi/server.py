...
class Server(object):
    def __init__(self, options):
        ...
        # Add log file to cherrypy configuration
        ...
        if paths.installed:
            ...
            logrotate_file = os.path.join(paths.logrotate_dir, "kimchi.in")
            ...
            config_file = open(os.path.join(paths.logrotate_dir, "kimchi"), "w")
